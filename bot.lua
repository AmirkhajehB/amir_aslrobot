...
`فقط کافیست یوزرنیم ربات یعنی @amir_ASLrobot را تایپ کنید و بعد از آن یک فاصله اضافه کنید و منتظر بمانید تا کلیدهای ربات ظاهر شود. با انتخاب هر کلید میتوانید از آن استفاده کنید. همانطور که گفته شد از این قابلیت میتوانید در چت های خصوصی، گروه ها و حتی کانال بهره ببرید.`
]]
...
{
{text = "Channel" , url = 'https://telegram.me/faze_shabane'},
{text = "Source" , url = 'https://github.com/AmirkhajehB/aslrobot'},
{text = "RoBoT" , url = 'https://telegram.me/amir_aslrobot'}
}
}
